...
Module hspi_devices
    ...
    Try
      ...
      Select Case dev_code
        Case DEV_INTERFACE.ToString
          ...
          '
          dv_name = "Welcome State"
          dv_type = "Welcome State"
  ...
  ''' <returns></returns>
  ''' <remarks></remarks>
  Public Function GetHomeSeerDevice(ByVal dv_root_name As String,
                                    ...
                                    ByVal dv_id As String) As String
    ...
    Try
      ...
      pdata.AddNamed("homes_id", gHomesId)
      pdata.AddNamed("dv_id", dv_id)
      ...
      Select Case dv_type
        Case "Welcome Person"
          '
          ' Netatmo Welcome Person
          '
          Dim strSnapshotFilename As String = FixPath(String.Format("{0}/{1}.jpg", "images/hspi_ultranetatmowelcome3/persons/", dv_addr.ToLower))
          dv.ImageLarge(hs) = strSnapshotFilename
          dv.Image(hs) = strSnapshotFilename

          DevicePairs.Clear()
          DevicePairs.Add(New hspi_device_pairs(0, "Away", "person_away.png", HomeSeerAPI.ePairStatusControl.Both))
          DevicePairs.Add(New hspi_device_pairs(1, "Home", "person_home.png", HomeSeerAPI.ePairStatusControl.Both))
        ...
        Case "Welcome Camera"
          ...
          '
          Dim strSnapshotFilename As String = FixPath(String.Format("{0}/{1}.jpg", "images/hspi_ultranetatmowelcome3/cameras/", dv_addr.ToLower))
          dv.ImageLarge(hs) = strSnapshotFilename
          dv.Image(hs) = strSnapshotFilename
          ...
          VSPair.PairType = VSVGPairType.SingleValue
          VSPair.Value = -2
          VSPair.Status = "Power Supply Issues"
          VSPair.Render = Enums.CAPIControlType.Button
          hs.DeviceVSP_AddPair(dv_ref, VSPair)
          ...
          VGPair.RangeStart = -3
          VGPair.RangeEnd = 0
          VGPair.Graphic = String.Format("{0}{1}", gImageDir, "camera_offline.png")
          hs.DeviceVGP_AddPair(dv_ref, VGPair)

          VGPair = New VGPair()
          VGPair.PairType = VSVGPairType.SingleValue
          VGPair.Set_Value = 1
          VGPair.Graphic = String.Format("{0}{1}", gImageDir, "camera_online.png")
          hs.DeviceVGP_AddPair(dv_ref, VGPair)
    ...
    Try
      ...
      Select Case deviceType
        ...
        Case "Netatmo Rain"
          ...
          If deviceType.Contains("Hour") = True Then
            strStatusSuffix &= "/h"
          End If
